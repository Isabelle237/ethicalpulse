...
urlpatterns = [
    ...
    path(
        ...
        scans_view.create_scheduled_scan,
        name="create_scheduled_scan",
    ),
    path(
        "scans/scheduled/<int:scan_id>/edit/",
        scans_view.edit_scheduled_scan,
        name="edit_scheduled_scan",
    ),
    path(
        "scans/scheduled/<int:scan_id>/delete/",
        scans_view.delete_scheduled_scan,
        name="delete_scheduled_scan",
    ),
    path(
        "scans/scheduled/<int:scan_id>/toggle/",
        scans_view.toggle_scheduled_scan,
        name="toggle_scheduled_scan",
    ),
    path(
        "scans/scheduled/<int:scan_id>/run-now/",
        scans_view.run_scheduled_scan_now,
        name="run_scheduled_scan_now",
    ),
    path(
        "scans/scheduled/<int:scan_id>/data/",
        scans_view.get_scheduled_scan_data,
        name="get_scheduled_scan_data",
    ),
]
