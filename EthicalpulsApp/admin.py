...
class ScanAdmin(admin.ModelAdmin):
    ...
    search_fields = (
        "name",
        "project__name",
    )  # Recherche par nom de scan et nom du projet
    ...
    def mark_as_completed(self, request, queryset):
        ...
        self.message_user(
            request, "Les scans sélectionnés ont été marqués comme terminés."
        )
    ...
    def mark_as_failed(self, request, queryset):
        ...
        self.message_user(
            request, "Les scans sélectionnés ont été marqués comme échoués."
        )
